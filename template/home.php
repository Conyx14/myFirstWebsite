...
<?php
        $titlegauchesection1= get_field("title_gauche_section1");
        $title2gauchesection1= get_field("title2_gauche_section1");
        $titlecentresection1= get_field("title_centre_section1");
        $title2centresection1= get_field("title2_centre_section1");
        $titledroitesection1= get_field("title_droite_section1");
        $title2droitesection1= get_field("title2_droite_section1");
        $colonnegauchesection1= get_field("colonne_gauche_section1");
        $colonnedroitesection1= get_field("colonne_droite_section1");
        $colonnecentresection1= get_field("colonne_centre_section1");
        $bloccentre= get_field("bloc_centre");
	?>
